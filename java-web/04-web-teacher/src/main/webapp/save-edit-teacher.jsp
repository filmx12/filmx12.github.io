...
<head>
<meta charset="UTF-8">
<meta http-equiv="Refresh" content="0; url=insert-teacher.jsp">
...
<body>
	...
	try {
		...
		String sql = "UPDATE teacher SET tname = '" + 
		tname + "', fname = '" + fname + "', lname = '" + 
		lname + "', gender = " + gender + ", dept = '" + dept + "', pic = '" + idcard + pictype + "' WHERE idcard = " + idcard; 
